  ...
  return (
    <div className="h-screen overflow-y-auto bg-[#060b16] text-white p-4 overflow-x-hidden w-full min-w-0">
      <div className="flex items-center justify-between mb-6">
        ...
        {profile?.role?.toLowerCase() === "college_coordinator" && (
          <button
...
const activityPayload = Array.isArray(newActivity)
  ...
  ? newActivity.map((activity) => ({
      ...
      target_students:
        Number(activity.target_students) || 0,
      ...
      assigned_to:
        activity.assignment_type === "individual"
  ...
  : [{
      ...
      target_students:
        Number(newActivity.target_students) || 0,
      ...
      assignment_type:
        newActivity.assignment_type,

      assigned_to:
        newActivity.assignment_type === "individual"
          ? newActivity.assigned_to
          : null,

      assigned_team_id:
        newActivity.assignment_type === "team"
          ? newActivity.assigned_team_id
          : null,
